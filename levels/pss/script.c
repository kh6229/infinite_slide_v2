...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		INSTANT_WARP(0x00, 0x01, 20000, 6403, 23817),
		INSTANT_WARP(0x01, 0x01, -20000, 6403, 23817),
		MARIO_POS(0x01, -180, -10000, 8266, 14150),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x00000000, bhvBlockSpawner),
		OBJECT(MODEL_NONE, -10000, 8266, 14150, 0, -180, 0, 0x000A0000, bhvSpinAirborneWarp),
