...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		MARIO_POS(0x01, 90, 0, 3299, 0),
		OBJECT(MODEL_BROKEN_R_MID, 0, 0, 0, 0, 0, 0, 0x00000000, bhvBrokenRMid),
		OBJECT(MODEL_NONE, 0, 3299, 0, 0, 90, 0, 0x000A0000, bhvSpinAirborneWarp),
