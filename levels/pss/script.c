...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_DOUBLE_TO_SINGLE, 0, 4627, 4036, -15, 0, 0, 0x00000000, bhvDoubleToSingle),
		OBJECT(MODEL_DOUBLE_STRAIGHT_LINE, 0, 5604, 7678, -15, 0, 0, 0x00000000, bhvDoubleStraightLine),
		OBJECT(MODEL_SINGLE_TO_DOUBLE, 0, 6582, 11320, -15, 0, 0, 0x00000000, bhvSingleToDouble),
